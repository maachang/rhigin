...
# ３）興味をお持ちの方は、rhiginをインストールして、実行してみてください

当プロジェクトのrhiginに、もしご興味をお持ちの方はrhiginをインストールして、実行していただければ幸いです。

以下の流れによって、rhiginをインストールして実行します。

- [gitからrhiginをクローンする](#3-1gitからrhiginをクローンして環境パスを通します)

- [RHIGIN_HOMEの環境パスを通す](#3-1gitからrhiginをクローンして環境パスを通します)

- [rhiginプロジェクトを作成する](#3-2rhigin用のプロジェクトを作成します)

- [rhiginプロジェクトを実行する](#3-3作成したプロジェクトを実際に動かしてみます)

５分ほどのお時間で実行できると思いますので、お試しいただければ幸いです。

_

## 3-1）gitからrhiginをクローンして、環境パスを通します
...
- [チュートリアルを見る](https://github.com/maachang/rhigin/blob/master/docs/tutorial.md)
