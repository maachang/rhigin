...
public class LogFactory {
	...
	// ログ出力処理.
	@SuppressWarnings("deprecation")
	public static final void write(final String name, final int logLevel, final long fileSize, final int typeNo,
			final String logDir, final Object... args) {
	...
	private static final class BaseLog implements Log {
		...
		public String toString() {
			return new StringBuilder("name:").append(name).append(", logLevel:").append(numberLogLevelByStr(logLevel))
					.append(", fileSize:").append(maxFileSize).append(", logDir:").append(logDir).toString();
		}
	}
}
