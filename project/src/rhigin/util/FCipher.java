...
public class FCipher {
	...
	private static final byte[] code16(String s) {
		int n, i, j;
		byte[] ret = new byte[] { (byte) 177, (byte) 75, (byte) 163, (byte) 143, (byte) 73, (byte) 49, (byte) 207,
				(byte) 40, (byte) 87, (byte) 41, (byte) 169, (byte) 91, (byte) 184, (byte) 67, (byte) 254, (byte) 89 };
		int len = s.length();
		for (i = 0; i < len; i++) {
	...
	private static final byte[] code16(byte[] s) {
		int n, i, j;
		byte[] ret = new byte[] { (byte) 87, (byte) 41, (byte) 169, (byte) 91, (byte) 184, (byte) 67, (byte) 254,
				(byte) 89, (byte) 177, (byte) 75, (byte) 163, (byte) 143, (byte) 73, (byte) 49, (byte) 207, (byte) 40 };
		int len = s.length;
		for (i = 0; i < len; i++) {
			n = s[i] & 0x000000ff;
			if ((i & 0x00000001) == 0) {
