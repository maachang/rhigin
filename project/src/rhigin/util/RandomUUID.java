...
public class RandomUUID {
	...
	public String getUUID() {
		return Converter.byte16ToUUID(xor128.nextInt(), xor128.nextInt(), xor128.nextInt(), xor128.nextInt());
	}
	 ...
	 */
	public int[] getInt4() {
		return new int[] { xor128.nextInt(), xor128.nextInt(), xor128.nextInt(), xor128.nextInt() };
	}
}
