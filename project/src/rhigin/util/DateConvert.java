 ...
 * 
 * 2)2013/03/01 -> java.sql.Date( 2013-1900,3-1,1 ) 13/03/01 -> java.sql.Date(2013-1900,3-1,1 ) 数値以外の区切り文字条件を解析.
 * 
...
public final class DateConvert {
  ...
  private static final int getYear(String v) {
    ...
    switch (v.length()) {
    case 0: return Converter.parseInt(h) - 1900;
    case 1: return Converter.parseInt(h.substring(0, h.length() - 1) + v) - 1900;
    case 2: return Converter.parseInt(h.substring(0, h.length() - 2) + v) - 1900;
  ...
  private static final java.util.Date cutDate(int type, String value) {
    ...
    if (type == 0) {
      ...
      default:
        return new java.sql.Date(getYear(list.get(0)), Converter.parseInt(list.get(1)) - 1, Converter.parseInt(list.get(2)));
      }
    }
    // java.sql.Time.
    else if (type == 1) {
      ...
      default:
        return new java.sql.Time(Converter.parseInt(list.get(0)), Converter.parseInt(list.get(1)), Converter.parseInt(list.get(2)));
      }
    }
    // java.sql.Timestamp.
    else {
      ...
      case 3:
        return new java.sql.Timestamp(getYear(list.get(0)), Converter.parseInt(list.get(1)) - 1, Converter.parseInt(list.get(2)), 0, 0, 0, 0);
      case 4:
        return new java.sql.Timestamp(getYear(list.get(0)), Converter.parseInt(list.get(1)) - 1, Converter.parseInt(list.get(2)), Converter.parseInt(list.get(3)), 0, 0, 0);
      case 5:
        return new java.sql.Timestamp(getYear(list.get(0)), Converter.parseInt(list.get(1)) - 1, Converter.parseInt(list.get(2)), Converter.parseInt(list.get(3)), Converter.parseInt(list.get(4)), 0, 0);
      case 6:
        return new java.sql.Timestamp(getYear(list.get(0)), Converter.parseInt(list.get(1)) - 1, Converter.parseInt(list.get(2)), Converter.parseInt(list.get(3)), Converter.parseInt(list.get(4)), Converter.parseInt(list.get(5)), 0);
      default:
        return new java.sql.Timestamp(getYear(list.get(0)), Converter.parseInt(list.get(1)) - 1, Converter.parseInt(list .get(2)), Converter.parseInt(list.get(3)), Converter.parseInt(list.get(4)), Converter.parseInt(list.get(5)), getMilliByNano(list.get(6)));
      }
    }
  }
  ...
  private static final java.util.Date stringDate(int type, String value) {
    ...
    if (type == 0) {
      ...
      if (len < 6) {
        ...
        return new java.sql.Date(getYear(value.substring(0, 4)),
          Converter.parseInt(value.substring(4, 6)) - 1, 1);
      } else {
        return new java.sql.Date(getYear(value.substring(0, 4)),
          Converter.parseInt(value.substring(4, 6)) - 1,
    ...
    // java.sql.Time.
      ...
      if (len < 4) {
        ...
        return new java.sql.Time(Converter.parseInt(value.substring(0, 2)),
          Converter.parseInt(value.substring(2, 4)),
          Converter.parseInt(value.substring(4, 6)));
      }
    }
    // java.sql.Timestamp.
    else {
      ...
      if (len < 6) {
        ...
        return new java.sql.Timestamp(getYear(value.substring(0, 4)),
                Converter.parseInt(value.substring(4, 6)) - 1,
                Converter.parseInt(value.substring(6, 8)), 0, 0, 0, 0);
      } else if (len < 12) {
        return new java.sql.Timestamp(getYear(value.substring(0, 4)),
          Converter.parseInt(value.substring(4, 6)) - 1,
          Converter.parseInt(value.substring(6, 8)),
        ...
        return new java.sql.Timestamp(getYear(value.substring(0, 4)),
          Converter.parseInt(value.substring(4, 6)) - 1,
          Converter.parseInt(value.substring(6, 8)),
          Converter.parseInt(value.substring(8, 10)),
          Converter.parseInt(value.substring(10, 12)), 0, 0);
      } else if (len < 17) {
        if (len == 14) {
          return new java.sql.Timestamp(
            ...
            Converter.parseInt(value.substring(6, 8)),
            Converter.parseInt(value.substring(8, 10)),
            Converter.parseInt(value.substring(10, 12)),
            ...
            return new java.sql.Timestamp(
              ...
              Converter.parseInt(value.substring(8, 10)),
              Converter.parseInt(value.substring(10, 12)),
              Converter.parseInt(value.substring(12, 14)),
  ...
  /**
   * Web上の日付フォーマットをTimestampに変換. こんな感じのフォーマット[Wed, 19-Mar-2014 03:55:33 GMT]を解析して 日付フォーマットに変換します.
