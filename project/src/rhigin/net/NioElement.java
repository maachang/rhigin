...
public abstract class NioElement {
	 ...
	 *                O例外.
	 */
	public SelectionKey registor(NioSelector selector, SocketChannel channel, int op) throws Exception {
	 ...
	 *                I/O例外.
	 */
	public void setSendData(InputStream in) throws IOException {
