...
public class UniqueIdObject {
	...
	private static final class Execute extends RhiginFunction {
		...
		public final Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
			...
			if(args.length >= 1) {
				switch(type) {
				case 1: return UniqueIdObject.get().get(Converter.convertInt(args[0]));
				case 2: return UniqueIdObject.get().get64(Converter.convertInt(args[0]));
				case 3: return UniqueIdObject.get().code64(Converter.convertString(args[0]));
				case 4: return UniqueIdObject.get().decode64(Converter.convertString(args[0]));
				}
			}
		...
		public final String getName() {
			...
			case 1: return "id";
			case 2: return "id64";
			case 3: return "code64";
			case 4: return "decode64";
			}
			return "unknown";
		}
